...
var onRequestOTP = function (otp, toPhoneNumber) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                accountSid = "AC0d404ee1e82650935f6ba092b4cab508";
                authToken = "02644805d088d963ef53b3577311fe0e";
                client = require('twilio')(accountSid, authToken);
                return [4 /*yield*/, client.messages.create({
                        body: "Your OTP for Delicious Circuit to create account is ".concat(otp),
                        from: '+16593007585',
                        to: "+91".concat(toPhoneNumber),
                    })];
            case 1:
                response = _a.sent();
